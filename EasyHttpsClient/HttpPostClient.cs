...
{
    public class HttpPostClient : HttpBaseClient
    {
        ...
        public override async Task<HttpBaseClient> SendAsync()
        {
            ...
            {
                throw new HttpRequestException("HttpRequestException in POST SendAsync", ex);
            }
            catch (TimeoutException ex)
            {
                throw new TimeoutException("TimeoutException in POST SendAsync", ex);
            }
            catch (Exception ex)
            {
                throw new Exception("Exception in POST SendAsync", ex);
            }
        }
    }
}